...
function MyListingItem ({ token, listingInfo, index, displayListings, setListingInfo, setListing, setDisplayListings, setPopUpDate, setSuccess, setPattern }) {
  ...
  const deleteListing = async () => {
    ...
    const response = await fetch(`http://localhost:${BACKEND_PORT}/listings/${listingInfo.id}`, body);
  ...
  const unPublish = async () => {
    ...
    const response = await fetch(`http://localhost:${BACKEND_PORT}/listings/unpublish/${listingInfo.id}`, body);
